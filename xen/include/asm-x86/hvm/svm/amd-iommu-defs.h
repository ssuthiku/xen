...
/* IOMMU GA Log entries: in power of 2 increments, minimum of 256 */
#define IOMMU_GA_LOG_DEFAULT_ENTRIES    512
#define IOMMU_GA_LOG_SIZE_SHIFT         56
#define IOMMU_GA_LOG_SIZE_512           (0x8ULL << IOMMU_GA_LOG_SIZE_SHIFT)
#define IOMMU_GA_LOG_BASE_ADDR_MASK     (((1ULL << 52) - 1) ^ 0xFFF)
#define IOMMU_GA_LOG_TAIL_ADDR_MASK     (((1ULL << 52) - 1) ^ 0x7)
...
#define IOMMU_CONTROL_GA_LOG_ENABLE_SHIFT		28
#define IOMMU_CONTROL_GA_LOG_ENABLE_MASK		(7UL << IOMMU_CONTROL_GA_LOG_ENABLE_SHIFT)
#define IOMMU_CONTROL_GA_LOG_INT_SHIFT			29
#define IOMMU_CONTROL_GA_LOG_INT_MASK			(1UL << IOMMU_CONTROL_GA_LOG_INT_SHIFT)
...
/* Guest Virtual APIC Log Register */
#define IOMMU_GA_LOG_BASE_ADDR_MMIO_OFFSET              0xE0
#define IOMMU_GA_LOG_TAIL_ADDR_MMIO_OFFSET              0xE8
#define IOMMU_GA_LOG_HEAD_OFFSET                        0x2040
#define IOMMU_GA_LOG_TAIL_OFFSET                        0x2048
...
#define IOMMU_STATUS_GA_LOG_OVERFLOW_MASK       0x00000100
#define IOMMU_STATUS_GA_LOG_OVERFLOW_SHIFT      8
#define IOMMU_STATUS_GA_LOG_INT_MASK            0x00000200
#define IOMMU_STATUS_GA_LOG_INT_SHIFT           9
#define IOMMU_STATUS_GA_LOG_RUN_MASK            0x00000400
#define IOMMU_STATUS_GA_LOG_RUN_SHIFT           10
